...
elseif CONFIG.CONTROL_KIND == 4
    ...
    reg.pinvTol            = 1e-3;
    reg.pinvTolVb          = 1e-7;
    reg.pinvDamp_ctrl3     = 0.001; % NOT USED    
end
